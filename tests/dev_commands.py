...
from pkusleeper.achievements.catalog import DEFAULT_ACHIEVEMENT_NAMES
from pkusleeper.domain import SleepEnvironment, SleepGoal, SleepRecord, SleepType
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--data-dir", default=PROJECT_ROOT / "data", type=Path, help="数据目录")
